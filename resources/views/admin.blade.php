...
<head>
    ...
    <link href="{{ url('/css/Admin/light-bootstrap-dashboard.css') }}" rel="stylesheet"/>
    ...
    <link href="{{ url('/css/Admin/css/pe-icon-7-stroke.css') }}" rel="stylesheet" />

</head>
<body>
<div class="wrapper">
    <div class="sidebar" data-color="green" data-image="{{ url('/images/Admin/sidebar-2.jpg')}}">
    ...
    -->
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="{{ url('profile/'.Auth::user()->id.Auth::user()->remember_token) }}">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                           <a href="profile" style="text-transform: capitalize">
                                 {{Auth::user()->name }}
                            </a>
                        </li>
                        <li class="dropdown">
    ...
    <script src="{{ url('/js/Admin/bootstrap-checkbox-radio-switch.js') }}"></script>
